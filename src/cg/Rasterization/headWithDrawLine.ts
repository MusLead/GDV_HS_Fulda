import { Matrix4, Vec3, matrix3ToMatrix4, matrix4Product, multVec3Matrix4, rotX, rotY, drawLine } from "../../_helper";
...
for (let i = 0; i <= 1; i += .01) {
    ...
    for (let f of faces) {
        ...
        drawLine(fvProjected[0], fvProjected[1], fb);
        drawLine(fvProjected[1], fvProjected[2], fb);
        drawLine(fvProjected[2], fvProjected[0], fb);
